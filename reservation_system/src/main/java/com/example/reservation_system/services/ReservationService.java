...
public class ReservationService {
    ...
    public void updateBusinessHours(Map<String, String> businessHours) {
    ...
    public int createReservation(Reservation reservation, String serviceType) {
    ...
    public Reservation convertToReservation(Map<String, Object> requestBody) {
        ...
        Reservation reservation = new Reservation(serv, user, startTime, endTime);
