...
public class AuthController {
    ...
    public AuthController(UserService userService, UserRepository userRepository, AuthenticationManager authenticationManager, PasswordEncoder passwordEncoder) {
    ...
    public ResponseEntity<?> changePassword(@PathVariable Long id, @RequestBody PasswordChangeRequest passwordChangeRequest, Authentication authentication) {
    ...
    @PutMapping("/users/{id}")
    public int updateUser(@PathVariable Long id, @RequestBody User userDetails) {
    ...
    public ResponseEntity<String> registerUser(@RequestBody User user) {
        ...
        if (user.getSurname() == null || user.getSurname().trim().isEmpty()) {
            return ResponseEntity.badRequest().body("Příjmení je vyžadováno.");
        }
        ...
        if (existingUserByUsername != null) {
            return ResponseEntity.badRequest().body("Uživatelské jméno je již zabráno.");
        }
    ...
    public ResponseEntity<Map<String, Object>> loginUser(@RequestBody User user) {
        try {
            ...
            User credentialsUser = userService.getUserByUsername(user.getUsername());
